...
export function LandingFeatures() {
  ...
  return (
    <section id="product" className="py-24 bg-muted/15 border-y border-border/40">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7">
            <div className="rounded-2xl border border-border/80 bg-card p-6 sm:p-8 shadow-xl relative overflow-hidden min-h-[440px] flex flex-col justify-between">
              <div className="flex items-center justify-between pb-4 border-b border-border/50 text-xs text-muted-foreground mb-6">
              ...
              <div className="pt-4 border-t border-border/40 text-[11px] text-muted-foreground flex justify-between font-mono">
