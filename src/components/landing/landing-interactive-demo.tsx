...
export function LandingInteractiveDemo() {
  ...
  return (
    <section id="playground" className="py-24 bg-background border-t border-border/40">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="rounded-2xl border border-border/80 bg-card shadow-xl transition-all duration-300 overflow-hidden relative p-6 sm:p-8">
          <div className="flex items-center justify-between border-b border-border/50 pb-3 mb-6 text-xs">
            <div className="flex items-center gap-2">
              ...
              <span className="text-[11px] text-muted-foreground">
                {saveStatus === "saved" ? (
                  <span className="text-emerald-600 dark:text-emerald-500/90 font-medium flex items-center gap-1">
